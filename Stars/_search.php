...
<body>
                ...
                <div id="topic" class="row-fluid">
                    <div id="topic-inner">
                        <div id="top-content" class="span12">
                            <div id="div_se" class="tw-para""><p><b>Descarga en curso...</b></p><p><br><img src="
                                _scripts/img/wait.gif" alt=""><br><br></p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script src="_scripts/search/search.js" charset="utf-8"></script>
