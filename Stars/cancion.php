...
<body background="_media/img/bd/d.jpg" width="30" height="10"></body>
                                ...
                                <ul id="toolbar1_r" class="nav pull-right">
                                    <li>
                                        <ul id="mainmenu" class="nav">
                                            ...
                                            <li><a href="cancion.php">Contacto</a></li>
                                            <li><a href="artista.php">Artista</a></li>
                                            <li><a href="usuario.php">Usuario</a></li>
                                            <li class="active"><a href="cancion.php">Canciones</a></li>
