...
<body>
    <div id="site">
        <div id="page">
            ...
            <div id="content" class="container-fluid">
                <h1 style="text-align:center">Su orden</h1>
                <div id="topic" class="row-fluid">
                    <div id="topic-inner">
                        <div id="top-content" class="span12">
                            <div class="row-fluid">
                                <div class="span12">
                                    <div id="div_co" class="tw-para"></div>
                                </div>
                                <div class="span12">
                                    <div align="center" id="div_sc_cookie" style="width:100%;"></div>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script src="_scripts/security/crypto.js"></script>
    <script src="_twsc/twsc.common.js" charset="utf-8"></script>
    <script src="_twsc/twsc.checkout.js" charset="utf-8"></script>
    <script src="_twsc/twsc.custform.js" charset="utf-8"></script>
    <script src="_twsc/twsc.data.js" charset="utf-8"></script>
    <script src="_twsc/twsc.delmode.js" charset="utf-8"></script>
    <script src="_twsc/twsc.paymode.js" charset="utf-8"></script>
    <script src="_twsc/twsc.paywith.js" charset="utf-8"></script>
    <script src="_twsc/twsc.shopcart.js" charset="utf-8"></script>
    <script src="_twsc/twsc.paypal.js" charset="utf-8"></script>
    <script src="_twsc/twsc.validate.js" charset="utf-8"></script>
