...
<head>
    ...
    <meta property="og:url" content="/beatshop.php" />
    <meta property="og:type" content="website" />
    <meta property="og:title" content="BEAT'SHOP" />
    <meta name="twitter:card" content="summary" />
    <meta name="twitter:title" content="BEAT'SHOP" />
...
<body style="background-color: #900C3F">
                                ...
                                <ul id="toolbar1_r" class="nav pull-right">
                                    <li>
                                        <ul id="mainmenu" class="nav">
                                            ...
                                            <li class="active"><a href="3.php">Tienda</a></li>
                                            <li><a href="4.php">Contacto</a></li>
                    ...
                    <div id="topic-inner">
                        <div id="top-content" class="span12">
                            <div class="row-fluid">
                                <ul class="thumbnails">
                                    <li class="span4">
                                        <div class="thumbnail"><a href="beatshop-instrumental-1.php">
                                                <div style="position:relative;z-index:10">
                                                        
                                                       </div><img
                                                    src="_media/img/thumb/ico3.png"
                                                    srcset="_media/img/small/ico3.png 3x"
                                                    style="max-width:100%;width:160px;" alt=""
                                                    data-zoom-image="_media/img/medium/ico3.png"
                                                    loading="lazy">
                                            </a>
                                            <div class="caption">
                                                <h3><a href="beatshop-instrumental-1.php">Instrumental #1</a></h3>
                                                
                                                <audio src="_media/music/a.mp3" controls="">Instrumental #1</audio>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="span4">
                                        <div class="thumbnail"><a href="beatshop-instrumental-2.php"><img
                                                    src="_media/img/thumb/ico3.png"
                                                    srcset="_media/img/small/ico3.png 3x"
                                                    style="max-width:100%;width:160px;" alt=""
                                                    data-zoom-image="_media/img/medium/ico3.png"
                                                    loading="lazy"></a>
                                            <div class="caption">
                                                <h3><a href="beatshop-instrumental-2.php">Instrumental #2</a></h3>
                                                
                                                <audio src="_media/music/b.mp3" controls="">Instrumental #2</audio>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="span4">
                                        <div class="thumbnail"><a href="beatshop-instrumental-3.php"><img
                                                    src="_media/img/thumb/ico3.png"
                                                    srcset="_media/img/small/ico3.png 3x"
                                                    style="max-width:100%;width:160px;" alt=""
                                                    data-zoom-image="_media/img/medium/ico3.png"
                                                    loading="lazy"></a>
                                            <div class="caption">
                                                <h3><a href="beatshop-instrumental-3.php">Instrumental #3</a></h3>
                                                
                                                <audio src="_media/music/c.mp3" controls="">Instrumental #3</audio>
                                            </div>
                                        </div>
                                    </li>
                                </ul>
                            ...
                            <div class="row-fluid">
                                <ul class="thumbnails">
                                    <li class="span4">
                                        <div class="thumbnail"><a href="beatshop-instrumental-4.php"><img
                                                    src="_media/img/thumb/ico3.png"
                                                    srcset="_media/img/small/ico3.png 3x"
                                                    style="max-width:100%;width:160px;" alt=""
                                                    data-zoom-image="_media/img/medium/ico3.png"
                                                    loading="lazy"></a>
                                            <div class="caption">
                                                <h3><a href="beatshop-instrumental-4.php">Instrumental #4</a></h3>
                                                
                                                <audio src="_media/music/d.mp3" controls="">Instrumental #4</audio>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="span4">
                                        <div class="thumbnail"><a href="beatshop-instrumental-5.php"><img
                                                    src="_media/img/thumb/ico3.png"
                                                    srcset="_media/img/small/ico3.png 3x"
                                                    style="max-width:100%;width:160px;" alt=""
                                                    data-zoom-image="_media/img/medium/ico3.png"
                                                    loading="lazy"></a>
                                            <div class="caption">
                                                <h3><a href="beatshop-instrumental-5.php">Instrumental #5</a></h3>
                                                
                                                <audio src="_media/music/e.mp3" controls="">Instrumental #5</audio>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="span4">
                                        <div class="thumbnail"><a href="beatshop-instrumental-6.php"><img
                                                    src="_media/img/thumb/ico3.png"
                                                    srcset="_media/img/small/ico3.png 3x"
                                                    style="max-width:100%;width:160px;" alt=""
                                                    data-zoom-image="_media/img/medium/ico3.png"
                                                    loading="lazy"></a>
                                            <div class="caption">
                                                <h3><a href="beatshop-instrumental-6.php">Instrumental #6</a></h3>
                                                
                                                <audio src="_media/music/f.mp3" controls="">Instrumental #6</audio>
                                            </div>
                                        </div>
                                    </li>
                                </ul>
    ...
    <script src="_twsc/twsc.common.js" charset="utf-8"></script>
    <script src="_twsc/twsc.checkout.js" charset="utf-8"></script>
    <script src="_twsc/twsc.data.js" charset="utf-8"></script>
    <script src="_twsc/twsc.shopcart.js" charset="utf-8"></script>
    <script src="_twsc/shop.js" charset="utf-8"></script>
    ...
    <script>$(document).ready(function () { $("#Grq29Z").html(dosc("dp", "Grq29Z", false, true, false, true)); dosc("up", "Grq29Z", true); $("#6zqxIf").html(dosc("dp", "6zqxIf", false, true, false, true)); dosc("up", "6zqxIf", true); $("#GhK72O").html(dosc("dp", "GhK72O", false, true, false, true)); dosc("up", "GhK72O", true); $("#NNLTxL").html(dosc("dp", "NNLTxL", false, true, false, true)); dosc("up", "NNLTxL", true); $("#ii54iU").html(dosc("dp", "ii54iU", false, true, false, true)); dosc("up", "ii54iU", true); $("#FGs94B").html(dosc("dp", "FGs94B", false, true, false, true)); dosc("up", "FGs94B", true); ucc(); if (typeof window.sessionStorage != "undefined") $("#button-cart").popover({ placement: "bottom", html: true, content: function () { return sessionStorage.getItem("scNDh-popover") || "<small>Su carrito está vacía</small>" }, trigger: "hover" }); $("#searchbox>input").click(function () { $(this).select(); }); $("#searchbox").click(function (e) { if (e.offsetX > e.target.width) { } else $("#searchbox").submit() }); if (location.href.indexOf("?") > 0 && location.href.indexOf("twtheme=no") > 0) { $("#toolbar1,#toolbar2,#toolbar3,#footersmall,#footerfat").hide(); var idbmk = location.href; idbmk = idbmk.substring(idbmk.lastIndexOf("#") + 1, idbmk.lastIndexOf("?")); if (idbmk != "") $("html,body").animate({ scrollTop: $("#" + idbmk).offset().top }, 0); } $("#site").prepend("<a href='javascript:void(0)' class='toTop' title='Arriba de la página'><i class='fa fa-angle-up fa-3x toTopLink'></i></a>"); var offset = 220; var duration = 500; $(window).scroll(function () { if ($(this).scrollTop() > offset) { $(".toTop").fadeIn(duration); } else { $(".toTop").fadeOut(duration); } }); $(".toTop").click(function (event) { event.preventDefault(); $("html, body").animate({ scrollTop: 0 }, duration); return (false); }); var s = document.location.href.toLowerCase(); if (typeof onTOWebPageLoaded == "function") onTOWebPageLoaded(); });</script>
</body>
