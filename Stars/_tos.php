                        ...
                        <div id="top-content" class="span12">
                            <div class="row-fluid">
                                <div class="span12 tw-para">
                                    <h2>Ámbito de Aplicación</h2>Este contrato describe los términos y condiciones
                                    generales aplicables al proceso de contratación y uso de los contenidos, productos y
                                    servicios ofrecidos a través del sitio https://smallstarsrecords.com/ en adelante
                                    “SITIO WEB”, del cual es titular SMALLS STARS RECORDS S.A.S, en adelante
                                    “SMALLS STARS RECORDS”. Cualquier persona que desee acceder a los servicios que en
                                    él se
                                    ofrecen a tal efecto en cualquiera de sus páginas web o mediante vía telefónica,
                                    podrá hacerlo sujetándose a los presentes TÉRMINOS Y CONDICIONES,así como políticas
                                    señalados en el presente documento. Si la persona no acepta los términos y
                                    condiciones, debe de abstenerse de adquirir el servicio.<h2>
                                        Privacidad</h2> En el desarrollo de la prestación del servicio el USUARIO podrá
                                    conocer información confidencial respecto a SMALLS STARS RECORDS S.A.S, por lo
                                    tanto, el
                                    USUARIO se obliga a guardar, a no transmitir, comunicar, revelar o cualquier forma
                                    divulgar total o parcialmente, pública o privadamente de absoluta reserva de la
                                    información y documentación de la cual llegare a tener conocimiento; En especial, no
                                    entregará ni divulgará a terceros salvo autorización previa y expresa del
                                    Representante Legal de SMALLS STARS RECORDS S.A.S o quien haga sus veces,
                                    información
                                    calificada por la parte reveladora como confidencial, reservada o estratégica.<h2>
                                        Limitación de la responsabilidad</h2> Interesados en los servicios, deberán
                                    hacer el contacto directo por medio de todos los relacionados en el Sitio Web. Todas
                                    las notificaciones y comunicaciones entre los USUARIOS y SMALLS STARS RECORDS S.A.S
                                    se
                                    considerarán eficaces, a todos los efectos, cuando se realicen a través de cualquier
                                    medio de los detallados en https://smallstarsrecords.com/<h2>Asistencia</h2> Los
                                    artistas del Genero Urbano o quienes pertenezcan a la industria musical, que
                                    requieran este servicio, y cumplan los requisitos para hacer efectiva dicha
                                    contratación, admiten haber leído, entendido y aceptado estos Términos y
                                    Condiciones, así mismo, están de acuerdo con sujetarse a ellos y a la legislación
                                    peruana aplicable.
                                    <br>
                                    <br>  <br>
                                    <br>  
